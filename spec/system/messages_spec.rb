...
RSpec.describe 'メッセージ投稿機能', type: :system do
  ...
  context '投稿に失敗したとき' do
    it '送る値が空の為、メッセージの送信に失敗する' do
      ...
      # DBに保存されていないことを確認する
      expect{click_on "commit"; sleep 1}.to change(Message, :count).by (0)
  ...
  context '投稿に成功したとき' do
    it 'テキストの投稿に成功すると、投稿一覧に遷移して、投稿した内容が表示されている' do
      ...
      expect{click_on "commit"; sleep 1}.to change{Message.count}.by (1)
    ...
    it '画像の投稿に成功すると、投稿一覧に遷移して、投稿した画像が表示されている' do
      ...
      # 添付する画像を定義する
      image_path = Rails.root.join('public/images/sample-image1.png')
